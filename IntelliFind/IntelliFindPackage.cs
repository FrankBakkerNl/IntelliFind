//------------------------------------------------------------------------------
// <copyright file="IntelliFindPackage.cs" company="Company">
...
namespace IntelliFind
{
    ...
    {
        /// <summary>
        /// IntelliFindPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "a114a511-bb21-4de4-b132-0e7b6999ccad";

        /// <summary>
        /// Initializes a new instance of the <see cref="IntelliFindWindow"/> class.
        /// </summary>
        public IntelliFindPackage()
        {
        ...
        {
            IntelliFindCommand.Initialize(this);
            base.Initialize();
        }
